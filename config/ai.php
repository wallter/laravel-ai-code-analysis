            ...
            'multi_pass_analysis' => [
                ...
                */
                'doc_generation' => [
                    ...
                    'type'        => 'both',
                    'prompt'      => implode("\n", [
                        "You are a professional documentation generator for a PHP codebase.",
                        "Create a COMPLETE, highly detailed documentation set for the code provided, drawing from both the AST data (structural details) AND the raw code.",
                        "In your final output, include sections such as:",
                        "- **Overview** (purpose and primary responsibilities of the class)",
                        "- **Properties** (list each property, including type or usage notes)",
                        "- **Methods** (detailed: name, parameters, types, return type, usage context, exceptions thrown, if any)",
                        "- **Example usage** if it’s clearly inferable from the code, or general usage notes (like 'typically called in startup' or 'best used in such scenario').",
                        "Format your result in **Markdown** with headings and subheadings, as in the example you recently produced. Keep it cohesive and well-organized.",
                        "",
                        "AST Data + Raw Code are provided. Generate the documentation now."
                    ]),
                    'max_tokens'  => 3000,
                    'temperature' => 0.3,
                ],
